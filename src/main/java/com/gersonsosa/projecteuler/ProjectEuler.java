...
public class ProjectEuler {
    public static void main(String[] args) {
        ...
        System.out.printf("Sum square difference of range %d - %d is %d%n", 1, 10, SumSquareDifference.sumSquareDifference(10));
        System.out.printf("Sum square difference of range %d - %d is %d%n", 1, 100, SumSquareDifference.sumSquareDifference(100));
    }
}
